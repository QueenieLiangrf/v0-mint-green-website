                  ...
                  {processes.map((process, index) => {
                    ...
                    return (
                      <div key={index} className="flex flex-col items-center relative">
                        ...
                        <div
                          className={`backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border-2 transition-all duration-700 shadow-lg hover:shadow-xl w-full h-56 sm:h-64 flex flex-col items-center text-center relative overflow-hidden bg-gradient-to-br from-blue-500/10 to-green-500/10 scale-[1.1475] origin-center cursor-pointer ${
                            isActive
                              ? "shadow-2xl shadow-blue-500/30 bg-gradient-to-br from-blue-500/20 to-green-500/15 transform scale-[1.26225] z-20"
                              : isPrevious
                                ? "shadow-lg shadow-blue-500/20 bg-gradient-to-br from-blue-500/15 to-green-500/10 transform scale-[1.090125] opacity-70"
                                : "transform scale-[1.1475] opacity-80"
                          }`}
